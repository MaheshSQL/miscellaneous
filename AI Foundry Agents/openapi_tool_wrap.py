...
from utils.user_openapi_implementation import OpenAPIWrapTool, create_get_weather_function
...
openapi_endpoint = os.environ["OPENAPI_ENDPOINT"]

# Create and initialize AzureLogicAppTool utility
openapi_tool = OpenAPIWrapTool(subscription_id = subscription_id, resource_group=resource_group, openapi_endpoint=openapi_endpoint)
print(f"Registered openapi_tool")

# Create the specialized "send_email_via_logic_app" function for your agent tools
get_weather_func = create_get_weather_function(openapi_tool)
